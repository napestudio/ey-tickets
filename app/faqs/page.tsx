      ...
      <section className="container pb-14">
        ...
        <div className="mb-6">
          ...
          <p className="text-xl text-white mb-6">
            ...
            Organizador). Comisión del 3% por uso de la plataforma (asumida por
            el Organizador).
            <br />
            <br />
            <strong>5. ¿Cómo uso mi ticket?</strong>
            <br />
            Al llegar al evento, presenta: El QR recibido por email (válido solo
            con el DNI registrado).
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-xl text-white mb-6">
            ...
            capacidad) y publica. Los pagos se reciben directamente en tu cuenta
            de Mercado Pago.
            <br />
            <br />
            ...
            <br />
            Sí, pero debes gestionar directamente con los compradores cualquier
            reembolso o cambio. EyTickets no se responsabiliza por reclamos
            derivados.
            <br />
            <br />
            <strong>4. ¿Cómo evito la reventa?</strong>
            <br />
            Los tickets emitidos en EyTickets tienen un QR vinculado al DNI del
            comprador, lo que garantiza su autenticidad y evita reventas.
            <br />
            <br />
            <strong>5. ¿Qué datos de los compradores recibo?</strong>
            <br />
            Solo los necesarios para el evento: nombre, DNI y email. Estos datos
            son privados y no pueden ser compartidos con terceros.
          </p>
        </div>
