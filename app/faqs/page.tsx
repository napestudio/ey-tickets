          ...
          <div className="container text-white py-10 flex flex-col gap-10">
            ...
            <div className="mb-6">
              ...
              <Paragraph className="text-xl text-white mb-6">
                ...
                <br />
                No. Los tickets son intransferibles y el QR está vinculado al
                DNI del comprador original. Si no puedes asistir, contacta al
                ...
                <br />
                La responsabilidad es exclusiva del Organizador. Debes
                contactarlo directamente para solicitar reembolsos o cambios.
                EyTickets no interviene en estas gestiones.
                <br />
                <br />
            ...
            <div className="mb-6">
              ...
              <Paragraph className="text-xl text-white  mb-6">
                ...
                del comprador, lo que garantiza su autenticidad y evita
                reventas.
                <br />
                <br />
