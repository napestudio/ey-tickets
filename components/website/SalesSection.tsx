        ...
        <div className="flex items-stretch w-full z-20 ">
          ...
          <div className="overflow-hidden w-4/5 flex flex-col bg-ey-dark gap-4 lg:gap-6 items-start justify-center p-6 lg:p-20 border-ey-turquoise border-0 rounded-4xl border-l-0">
            ...
            <div className="flex flex-col gap-4">
              <div className="">
                <Paragraph className="text-white text-xs md:text-lg mb-2 leading-[1.1] text-balance md:text-pretty">
                  No esperes a que finalice el evento para cobrar tus ventas.
                </Paragraph>
                <Paragraph className="text-white text-xs md:text-lg leading-[1.1] text-balance md:text-pretty">
